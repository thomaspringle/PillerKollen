...
//            mDatePickerDialog = new DatePickerDialog(this, mModel.endDate.year, mModel.endDate.month, mModel.endDate.monthDay);
            mDatePickerDialog = new DatePickerDialog(getActivity(), R.style.AppBaseTheme, this, 
...
//        mDatePickerDialog = (DatePicker) getFragmentManager().findFragmentByTag(FRAG_TAG_DATE_PICKER);
//        if (mDatePickerDialog != null) {
